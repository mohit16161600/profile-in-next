        ...
        <div className="bg-[#050505] min-h-screen">
            ...
            <section className="py-12 -mt-16 relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {/* YOUTUBE */}
                        <div className="glass p-8 rounded-2xl shadow-xl border border-white/5 flex flex-col items-center text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
                            <div className="w-16 h-16 rounded-full bg-red-500/10 text-red-500 flex items-center justify-center mb-4 group-hover:bg-red-600 group-hover:text-white transition-colors">
                            ...
                            <h2 className="text-xl font-bold text-white">Content Creator</h2>
                            <p className="text-sm text-gray-400 mb-6">Posting coding tutorials & tech reviews</p>
                        ...
                        {/* INSTAGRAM */}
                        <div className="glass p-8 rounded-2xl shadow-xl border border-white/5 flex flex-col items-center text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
                            <div className="w-16 h-16 rounded-full bg-pink-500/10 text-pink-500 flex items-center justify-center mb-4 group-hover:bg-gradient-to-tr group-hover:from-yellow-400 group-hover:via-red-500 group-hover:to-purple-500 group-hover:text-white transition-colors">
                            ...
                            <h2 className="text-xl font-bold text-white">Daily Life</h2>
                            <p className="text-sm text-gray-400 mb-6">Sharing behind the scenes & lifestyle</p>
                        ...
                        {/* GITHUB */}
                        <div className="glass p-8 rounded-2xl shadow-xl border border-white/5 flex flex-col items-center text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
                            <div className="w-16 h-16 rounded-full bg-white/10 text-gray-300 flex items-center justify-center mb-4 group-hover:bg-white group-hover:text-black transition-colors">
                            ...
                            <p className="text-sm text-gray-400 mb-6">Building & contributing to projects</p>
                            <a href="https://github.com/mohit16161600" target="_blank" rel="noopener noreferrer"
            ...
            <section className="py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-gray-400">Snapshots from my journey.</p>
                    </div>

                    <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
                        {galleryImages.map((img, index) => (
                            <div key={index} className="break-inside-avoid relative group rounded-2xl overflow-hidden shadow-sm hover:shadow-primary-500/20 hover:shadow-2xl transition-all duration-300 border border-white/5 bg-gray-900">
                                <Image
                                    src={img.src}
                                    alt={img.alt}
                                    width={600}
            ...
            <section className="py-24 bg-[#0a0a0a] border-t border-white/5">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-400 mb-10 text-lg">Whether you need a website, a mobile app, or a full-stack solution, I'm here to help.</p>
