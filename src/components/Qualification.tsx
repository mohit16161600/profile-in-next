    ...
    <section id="qualification" className="py-24 bg-transparent relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Degree */}
          <div className="reveal reveal-d1 glass rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-300 border-t-4 border-t-primary-600 border-x border-b border-white/5 group">
          ...
          {/* Certification */}
          <div className="reveal reveal-d2 glass rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 border-t-4 border-t-emerald-600 border-x border-b border-white/5 group">
          ...
          {/* DSA */}
          <div className="reveal reveal-d3 glass rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 border-t-4 border-t-purple-600 border-x border-b border-white/5 group">
