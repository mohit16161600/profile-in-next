    ...
    <section id="skills" className="py-24 bg-transparent relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Frontend */}
          <div className="reveal reveal-d1 glass rounded-2xl p-8 shadow-sm border border-white/5 hover:border-primary-500/30 transition-all duration-300 group">
          ...
          {/* Backend */}
          <div className="reveal reveal-d2 glass rounded-2xl p-8 shadow-sm border border-white/5 hover:border-green-500/30 transition-all duration-300 group">
            <h3 className="text-xl font-bold text-white mb-6 flex items-center">
          ...
          {/* Tools & Others */}
          <div className="reveal reveal-d3 glass rounded-2xl p-8 shadow-sm border border-white/5 hover:border-purple-500/30 transition-all duration-300 group">
            <h3 className="text-xl font-bold text-white mb-6 flex items-center">
