...
export const BLOG_POSTS: BlogPost[] = [
    ...
    },
    {
        ...
        description: "Exact Hostinger renewal rates for Premium, Business, Cloud and domains in India — how much your bill jumps after the intro term, the 4-year cost math, and 5 legit ways to avoid paying full renewal price.",
        date: "August 9, 2026",
    ...
    },
    {
        ...
        description: "Hostinger WordPress hosting reviewed by a developer running client WP sites on it — LiteSpeed speed, one-click setup walkthrough, plan picks for blogs vs WooCommerce, and the honest limitations.",
        date: "August 9, 2026",
        readTime: "12 min read",
        category: "Hosting",
        views: 0,
    ...
    },
    {
        ...
        description: "Your GoDaddy renewal bill jumped 2–4× the intro price? Why it happens, how to check what you'll really pay, legit ways to lower it, and a 6-step no-downtime migration when moving makes more sense.",
        date: "August 9, 2026",
        readTime: "11 min read",
        category: "Hosting",
        views: 0,
    ...
    },
    {
        ...
        description: "Every hosting option under ₹200/month in India compared honestly — what ₹99 vs ₹139 vs ₹199 really buys, the 5 corners budget hosts cut, renewal traps, and the best pick per use case.",
        date: "August 9, 2026",
